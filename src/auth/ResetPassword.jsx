  ...
  return (
    <div className="row g-0 app-auth-wrapper">
            ...
            <div className="auth-form-container text-left">
              <form className="auth-form resetpass-form">
                ...
                <div className="text-center">
                  <button
                    type="submit"
                    className="btn app-btn-primary btn-block theme-btn mx-auto"
                  >
                    Reset Password
                  </button>
                </div>
              ...
              <div className="auth-option text-center pt-5">
                <a className="app-link" href="login.html">
                  Log in
                </a>{" "}
      ...
      <div className="col-12 col-md-5 col-lg-6 h-100 auth-background-col">
        <div className="app-reset-password-auth-background-holder"></div>
