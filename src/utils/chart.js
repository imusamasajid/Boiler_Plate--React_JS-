...
window.addEventListener("load", function () {
  ...
  var AreaLineChart = document.getElementById("chart-line").getContext("2d");
  window.myLine = new Chart(AreaLineChart, AreaLineChartConfig);

  var barCharts = document.getElementById("chart-bar").getContext("2d");
  window.myBar = new Chart(barCharts, barChartsConfig);
